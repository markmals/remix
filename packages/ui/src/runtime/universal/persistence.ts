...
const registry: unique symbol = Symbol('remix.renderer.persistence')
...
export function createRendererPersistence<
  ...
  element extends node,
  container extends node = element,
>(): RendererPersistence<node, element, container> {
 ...
 */
export function retainHostRemoval<
  node extends object,
  element extends node,
  container extends node,
>(
  persistence: RendererPersistence<node, element, container>,
  target: MountedHost<node, element, container>,
  parent: element | container,
): RetainedRemoval | null {
 ...
 */
export function settleRetainedRemoval<
  node extends object,
  element extends node,
  container extends node,
>(
 ...
 */
export function reclaimRetainedHost<
  node extends object,
  element extends node,
  container extends node,
>(
 ...
 */
export function findRetainedHost<node extends object, element extends node, container extends node>(
  persistence: RendererPersistence<node, element, container>,
  type: string,
  key: Key | undefined,
  parent: element | container,
): MountedHost<node, element, container> | null {
