 ...
 */
type CustomEventMap<target extends EventTarget> = target extends TypedEventTarget<infer map> ? unknown extends map ? Record<string, Event> : NonNullable<map> : Record<string, Event>;
/**
 ...
 */
export type EventMap<target extends EventTarget> = target extends HTMLElement ? HTMLElementEventMap : target extends SVGSVGElement ? SVGSVGElementEventMap : target extends SVGElement ? SVGElementEventMap : target extends Element ? ElementEventMap : CustomEventMap<target>;
export {};
